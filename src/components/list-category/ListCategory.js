...
// //import { getUserByEmailPassword } from '../../e-commerce-admin-api/models/user/User.model'
...
//     const childCats = categoryList.filter(row => row.parentCat)
            ...
            //             {row.name} 
            //             <span className="item-buttons ml-5" style={{marginLeft:"5rem"}}>
            //             <Button >Edit</Button>
            ...
            //           {
            //               childCats.map(itm => itm.parentCat === row._id && (
            //                 <ListGroup.Item key={i}>{`--> ${itm.name}`}
            //                  <span className="item-buttons ml-5"  style={{marginLeft:"5rem"}}>
            //                  <Button >Edit</Button>
            //                  <Button variant = 'danger'
            //                  onClick={()=> handleOnDeleteClicked(row._id)}
